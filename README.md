...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-04 01:11`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0f201cab-fbaa-4e55-b120-db749d8672a0.git
$ cd 0f201cab-fbaa-4e55-b120-db749d8672a0
```
